    ...
    public partial class RegistrarUsuario : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
          ...
          //  usuario.RolUsuario = txtRol.Text;
            ...
            if (txtNomUsuario.Text != "" && txtPass.Text != "" && txtRut.Text != "" && txtApPaterno.Text != "" && txtApMaterno.Text != "" && txtEmail.Text != "")
            {
                if (txtPass.Text == txtCPass.Text)
                {
                    ...
                    String value = "insert into Usuario values('" + txtIdUser.Text + "','" + usuario.NombreUser + "','" + usuario.PassUser + "','" + usuario.RolUsuario + "','" + txtIdPersona.Text + "','" + usuario.Email + "')";
